            ...
            <?php foreach ($all_categories as $cat) : ?>
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_categorie.php?id=<?php echo (int)$cat['id']; ?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Edit">
                      <i class="fa-solid fa-pen"></i>
                    </a>
                    <a href="delete_categorie.php?id=<?php echo (int)$cat['id']; ?>" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Remove">
