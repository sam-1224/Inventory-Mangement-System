      ...
      <div class="panel-body" style="max-width: fit-content;">
          ...
          <div class="form-group">
            ...
            <div class="form-group clearfix">
                    <a href="change_password.php" title="change password" class="btn btn-success pull-right" style="margin:10px;" >Change Password</a>
                    <button type="submit" name="update" class="btn btn-info" style="margin:10px;">Update</button>
            </div>
        </form>
      </div>
    </div>
